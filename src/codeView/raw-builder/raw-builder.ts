...
import type { RawNode } from '../../shared/operation-node/raw-node.js'
import type { CompiledQuery } from '../../types/query-compiler/compiled-query.js'
import type { QueryExecutor } from '../../types/query-executor/query-executor.js'
import { freeze } from '../../shared/util/object-utils.js'
import type { KyselyPlugin } from '../../types/plugin/kysely-plugin.js'
import { NOOP_QUERY_EXECUTOR } from '../../shared/query-executor/noop-query-executor.js'
import type { QueryExecutorProvider } from '../../types/query-executor/query-executor-provider.js'
