// Runtime-only: the abort/cancellation functions and the ABORTED sentinel symbol
// all survive TypeScript compilation and belong in shared/. The interface and
// type alias definitions (AbortableOperationOptions, AbortableQueryOptions,
